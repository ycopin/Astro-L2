% Time-stamp: <2012-02-06 14:18:15 ycopin>
...
\begin{Exercise}[La matière noire]
  ...
  \item Écrire la relation fondamentale de la dynamique pour cette
    étoile. On suppose $R$ grand de façon à pouvoir écrire
    $F=GmM(R)/R^2$. En déduire la relation entre $V$ et $R$. Comment
    varie alors $V$ en fonction de $R$ ?
  ...
  \item Quelle forme de la densité de masse $\rho(r)$ doit-on présumer
    ...
    note que dans une sphère de rayon $R$, on a :
    $$
...
\begin{Answer}
  ...
  (megaparsecs) en kilomètres, et il vient : $1/t_{H} =
