% Time-stamp: <2013-04-03 15:55 ycopin@lyopc469>
...
\begin{Answer}
  \begin{center}
    \begin{tabular}{lccc}
      ...
      \hline
      $d$ (pc) &
      2,64 $\pm$ 0,01 & 20,0 $\pm$ 0,4 & 130 $\pm$ 30 \\
      $\Delta d / d$ & 0,4\% & 2\% & 21\% \\
      $M_V$ & 1,42  & -0,65 & -4,99 \\
      \hline
    \end{tabular}
...
\begin{Answer}
  \begin{center}
    \begin{tabular}{lccc}
      ...
      & & Neptune & Pluton \\
      \hline\hline
      Demi-grand axe & $a$ & 30,06~\UA & 39,43~\UA \\
      Excentricité & $e$ & 0,009 & 0,248 \\
      Périhélie & $d=a(1-e)$ & 29,79~\UA & 29,65~\UA \\
      Aphélie & $D=a(1+e)$ & 30,33~\UA & 49,21~\UA \\
      \hline
    \end{tabular}
  \end{center}
...
\begin{table}  
  ...
  \begin{tabular}{lcccccc}
    ...
    \hline
    \hline
    $M_{\mathrm{totale}}$ ($10^{10}M_{\odot}$) & 
    & 22,6 & 32,4 & 19,0 & 7,9 & 1,6 \\
...
%       \hline
%       \No & Nom & Morphologie & Classification RC3 \\ 
%       \hline
%       \hline
%       1  & NGC6070    & SA  & SA(s)cd  \\ 
%       2  & NGC 7424   & SAB & SAB(rs)cd  \\ 
%       3  & M 31 & SA  & SA(s)b  \\ 
%       4  & M 33 & SA  & SA(s)cd  \\ 
%       5  & M 87 & E0 ou E1 & E+0-1 pec\footnotemark[1] \\ 
%       6  & NGC 2683   & SA  & SA(rs)b  \\ 
%       7  & NGC 1300   & SB  & (R')SN(r'1)b  \\ 
%       8  & NGC 1097   & SB  & (R'\_1:)SB(r'l)b  \\ 
%       9  & NGC 4321   & SAB & SAB(s)bc \\ 
%       10 & M 83 & SAB & SAB(s)c \\ 
%       \hline
%     \end{tabular}
...
%   Galaxies lointaines sans nom (11). La classification demandée est
...
\begin{Answer}
  ...
  \item $\d M(R)/\d R = 4\pi R^2 \rho(R) \stackrel{\mathrm{PFD}}{=}
    \d(RV_{0}^{2}/G)/\d R$ d'où $\rho(R) = \frac{1}{4\pi R^2}
    \frac{V_0^2}{G} \propto 1/R^{2}$.
  \end{enumerate}
\end{Answer}
...
\begin{Exercise}[Le centre galactique]
  ...
  grand-axe de $a = 0,119$~arcsec), retrouver l'estimation de la masse
...
\begin{Answer}
  ...
  $$
  \frac{(a/1~\mathrm{UA})^{3}}{(T/1~\mathrm{an})^{2}} =
  M_{\mathrm{SgrA}*}/M_{\odot} 
  \qquad\text{avec}\qquad 
  (a/1~\mathrm{UA}) = (a/1'') \times (R/1~\mathrm{pc}) = 1,011\e{3}
  $$
...
\begin{Answer}
  ...
  \item Par ailleurs, $1 + z =
    ...
    = 121,5/582,2 = 0,209$.  À l'époque où 4C41.17 émettait la lumière
