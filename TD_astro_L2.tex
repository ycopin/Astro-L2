% Time-stamp: <2013-03-13 14:42 ycopin@lyopc469>
...
\begin{Answer}
  ...
  \item On rappelle l'expression du module de distance $m-M =
    5\log(D/10\,\u{pc})$ soit $\log(D/1\,\u{pc}) = 0,2(m-M)+1$. Or le
    nombre $N(m)$ d'étoiles d'une « visibilité » supérieure à une
...
\begin{Answer}
  ...
  \item Calcul de l'extinction: $E_{B-V} = (A_B- A_V) = (B-V )-
    (B-V)_0 = 2,25-(-0,25) = 2,5$.  Le graphique donne $A_V \simeq 3
    E_{B-V}$, d'où $A_V = 3 \times 2,5 = 7,5$.
