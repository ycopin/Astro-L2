% Time-stamp: <2015-06-16 19:37:45 ycopin>
...
\begin{Exercise}[Densité critique]
  ...
  \simeq m_{n} \simeq m_{u} = 1,66\e{-27}$~kg), puis en $M_{\odot}/\u{Mpc}^{3}$.
  Commenter.
\end{Exercise}

\begin{Answer}
  $\rho_{C} = 9,20\e{-27}~\u{kg\;m^{-3}} = 5,54\;\text{nucléons}\;\u{m^{-3}} =
  1,34\e{11}\;M_{\odot}\;\u{Mpc}^{-3}$, soit environ une galaxie (massive) par
  \u{Mpc^{3}}, densité caractéristique de l'Univers local.
\end{Answer}
