% Time-stamp: <2015-04-08 14:44 ycopin@lyonovae03.in2p3.fr>
...
\begin{Answer}
  ...
  température et au rayon par $L_{\odot} = 4 \pi R_{\odot}^2 \sigma
  T_{\odot}^{4}$ avec la constante de Stefan $\sigma =
  5,67\e{-8}$~\u{W~m^{-2}~K^{-4}}, soit $L_{\odot}\approx
  3,83\e{26}$~W.
\end{Answer}
...
\begin{Answer}
  ...
  \theta_*[''] / 2$ soit $R = 7,8\e{-3}\;\u{UA} = 1,67\;R_{\odot}$.
...
\begin{Answer}
  ...
  \item La 3ème loi de Kepler (en unités réduites) donne la somme des
    masses : $M_{1} + M_{2} = 30\;M_{\odot} = 5,97\e{31}$~kg.
...
\begin{Answer}
  ...
  $$
  d'où $M_{\mathrm{SgrA}*} = 4,5\e{6}\;M_{\odot} \gg M_{\mathrm{visible}}$.
\end{Answer}
...
\begin{Answer}
  ...
  4,302\e{-3}\;\u{km^{2}~s^{-2}~pc~M_{\odot}^{-1}}$.
\end{Answer}
...
\begin{Answer}
  ...
  4,500\e{-15}$~\u{pc^{3}~M_{\odot}^{-1}~an^{-2}}.
...
\begin{Exercise}[La faiblesse de la force de gravitation]
  ...
  Naomi 580~N.  Le rayon de la Terre à Lyon sera supposé égal à
...
\begin{Answer}
  ...
  Fig.~\ref{grav}, la cabine de gauche, supposée à grande distance de
  la planète, et accélérée vers le haut (flèche bleue), produit des
  forces parallèles (flèches rouges) sur les deux masses-test.  La
  cabine de droite, immobile dans le champ de gravitation de la Terre,
  montre des forces convergentes vers le centre de la Terre (flèches
  vertes).  De même, le physicien pourrait mettre en évidence une
  dépendance de la force avec l'altitude dans le cas de droite.
  \begin{SCfigure}%[htp]
    \centering
