% Time-stamp: <2012-04-23 02:26 ycopin@lyopc469>
...
\begin{Exercise}[Équilibre radiatif de la Terre]
  ...
  \item Application numérique, sachant que $L=3,85\times 10^{26}$~W,
    $R=6400$~km, $D=1,5\times10^{11}$~m, $\sigma =
    5,67\times10^{-8}$~\u{J.s^{-1}.m^{-2}.K^{-4}}.
...
\begin{Answer}
  ...
  \item Son diamètre apparent vaut $\theta_*= 5,89~\u{mas} = 2,86 \times
    10^{-8}$~rad.
  \item Son rayon vaut donc $R = \theta_* d / 2 = 3,8 \times
    10^{-8}\;\u{pc} = 1,2 \times 10^9\;\u{m} = 1,7\;R_{\odot}$.
  \end{itemize}
...
\begin{Answer}
  \begin{align*}
    ...
    L &= 2\;\u{kpc} = 6,17\times 10^{21}\;\u{cm} \\
  ...
  $$
  n_g L = \frac{\tau}{s_g} = \frac{0,55}{\pi 10^{-10}} = 1,75\times
  10^9~[\u{grain/cm^2}]
  $$
  On déduit de l'expression précédente la densité de grains $n_g$ :
  $$
  n_g = \frac{1,75\times  10^{9}}{6\times  10^{21}} = 2,82\times
  10^{-13}~[\u{grain/cm^{3}}]
  $$
  ...
  2,9\times 10^{-13}
  [\u{grain/cm^3}]= 1,18\times 10^{-27}~[\u{g/cm^3}]
  $$
  Masse volumique du gaz dans le MIS :
  $$
  8~[\u{atomes/cm^3}] 1,67352\times 10^{-24}~[\u{g/atome}] = 1,34\times
  10^{-23}~[\u{g/cm^3}]
  $$
  $$
  \frac{\text{Masse volumique des grains}}{\text{Masse volumique du
      gaz}} = \frac{1,18\times 10^{-27}~[\u{g/cm^3}]}{1,34\times
    10^{-23}~[\u{g/cm^3}]} = 8,8\times 10^{-5}
  $$
...
\begin{Exercise}[Théorème du Viriel scalaire]
  ...
  \item Énoncer le théorème du Viriel. En déduire l'expression de la
    ...
    l'application numérique, sachant que $M_\odot=2\times10^{30}$~kg,
    $M_\oplus=5,97\times10^{24}$~kg et $v_\oplus=30$~km/s.
...
\begin{Answer}
  On a $M = 2RV^{2}/G$, avec $G = 6,67\times 10^{-11}\;\u{SI} =
  4,302\times 10^{-3}\;\u{km^{2}.s^{-2}.pc.M_{\odot}^{-1}}$ d'où:
  \begin{center}
    \begin{tabular}{|c|c|c|c|}
      \hline
      Système & $R$ & $V$ (km/s) & $M$ ($M_{\odot}$) \\ \hline
      Amas globulaire  & 10~pc  & 10   & \red{$4,6\times 10^{5}$} \\ \hline
      Galaxie          & 50~kpc & 200  & \red{$9,3\times 10^{11}$} \\ \hline
      Amas de galaxies & 1~Mpc  & 1000 & \red{$4,6\times 10^{14}$} \\ \hline
    \end{tabular}
  \end{center}
\end{Answer}
...
\begin{Answer}
  $t_{c} = R/V = \sqrt{2R^{3} / GM}$ avec $G = 4,500\times
  10^{-15}\;\u{pc^{3}.M_{\odot}^{-1}.an^{-2}}$ donc:
  \begin{center}
    \begin{tabular}{|c|c|c|c|}
      \hline
      Système & $R$ (pc) & $M$ ($M_{\odot}$) & $t_c$ (ans) \\ \hline
      Amas ouvert     & 1~pc   & 500      & \red{$9,4\times 10^5$} \\ \hline
      Amas globulaire & 10~pc  & $10^5$   & \red{$2,1\times 10^6$} \\ \hline
      Galaxie         & 50~kpc & $10^{12}$ & \red{$2,4\times 10^8$} \\ \hline
    \end{tabular}
  \end{center}
...
\begin{Answer}
  ...
  10^{-11} \times 5,976 10^{24} ) = 2,85 10^{-8}\;\u{kg} = 28,5$~\u{\mu
    g}.
...
\begin{Answer}
  $\rho_{C} \simeq 9\times 10^{-10}~\u{J m^{-3}} \simeq
  6$~nucléons/\u{m^{3}}
\end{Answer}
